...
/*
 ...
 - 상속을 적용시키려면 자식 클래스 선언부의 클래스 이름 뒤에 키워드 extends를 쓰고,
   물려받을 부모 클래스의 이름을 적는다.
 */
public class Warrior extends Player{
	...
	/*
	 ...
	 - 부모가 물려주는 메서드는 모든 자식들에게 다 맞게 설계되기 힘들기 때문에
	   부족한 점이 있거나, 아예 맞지 않는 경우 자식 클래스 쪽에서 내용을 추가하거나
	   수정할 수 있다. 이를 '오버라이딩'이라 한다.
	 ...
	 */
//	void characterInfo(){
//		super.characterInfo();  //메서드 재정의 method overriding
//		System.out.println("#분노: " + rage);
//	}
