 ...
 */
/*
 - 자바에서는하나의 클래스 파일에 여러 개의 클래스를 선언할 수 있다.
...
public class Basic {
	...
	/* '타입의 규격화'
	 ...
	 - 부모 타입 변수에 자식 객체의 주소값을 얼마든지 저장할 수 있다는 것을 의미한다.
	 */
...
//	D v11 = new E(); (x)
	...
	//Object는 자바의 최상위 클래스다. 모든 클래스는 결국 Object의 자식이다
	//Object 타입의 변수에는 어떠한 객체도 들어올 수 있다.
	
	Object o1 = new A();  //object: A의 부모
	Object o2 = new B(); 
	Object o3 = new C();  
	Object o4 = new D();  
	Object o5 = new E();
	Object o6 = new String("안녕하세요");
	Object o7 = new Basic();  //Basic은 현재 클래스, Object의 자식/ 크로노스급
