...
public class MyBirth {
	...
	/*
	 ...
	 - 따라서 데이터의 유효성을 검증할 수 있는 제어문이 포함된
	   ...
	   이때 사용하는 메서드를 getter/ setter메서드라고 부른다. 
	
	 # setter method
	 1. setter는 숨겨진 변수에 값을 저장하기 위한 메서드이다.
	 2. 메서드 내부에 데이터 유효성 검증 로직을 작성하여
	    적절한 데이터만 멤버변수에 저장시키고, 접근 제한자는 public으로 설정하여
	    외부에서 누구나 사용할 수 있게 한다.
	 3. 메서드 이름은 일반적으로 set + '멤버변수이름' 으로 설정한다.	 
	 4. setter는 무엇에 어떤값을 넣기 위함이다. 그래서 return이 없다.
	 */
	...
	/*
	 ...
	 3. getter의 역할은 무엇을 가져오기위함이다. 
	    그래서 return 원하는값; 을 쓴다.
	 */
