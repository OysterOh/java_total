...
/*
  #매개 변수(parameter, argument)
   ...
   2. 메서드 호출부에서 어떤 매개값을 전달하느냐에 따라 메서드의 실행결과는 달라질 수 있다. 
   3. 매개 값을 몇 개 받아서 사용할지는 메서드를 선언할 때 선언부에서 
      ()안에 미리 개수와 타입을 지정한다.
   4. 매개변수의 이름을 지을 때는 호출자가 선언부로 돌아와서 매개값을 확인하지 않게, 
      어떠한 값을 담는 변수인지 그 뜻을 알기 쉽게 지어주는게 좋다.
   5. 매개변수를 하나도 선언하지 않을 수도 있다. 이때는 메서드의 선언부에 ()내부를 비워둔다.
      호출할 때도 ()를 비워서 호출한다.   
 */
public class MethodExample2 {
	...
	public static void main(String[] args) {
		...
		sum = calcNumberTotal(new int[] {1,2,3,4,5,6,7});  //즉석 배열 선언
		System.out.println("누적합: " + sum);
		
		//가변 파라미터에 값을 보낼 때는 콤마로 쭉 나열하거나
		//배열로 포장해서 보내도 된다.
		sum = calcNumberTotal2(1,2,3,4,5,6,7,8);
		System.out.println("누적합: " + sum);
	}
